        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-form :fields="[
                                ['name' => 'course_id', 'label' => 'Course', 'type' => 'text', 'icon' => 'book', 'value' => $courseModule->course->name],
                                ['name' => 'title', 'label' => 'Title', 'type' => 'text', 'icon' => 'book', 'value' => $courseModule->title],
                                ['name' => 'type', 'label' => 'Type', 'type' => 'text', 'icon' => 'tag', 'value' => $courseModule->type],
                    ...
                    <a href="{{ route('course_modules.edit', $courseModule) }}"
